...
# the soccer field dimensions in meters (comented and replaced by SPL Dimensions)
...
addSoccerVar('FieldHeight', 40.0)
addSoccerVar('GoalWidth', 1.6)
addSoccerVar('GoalDepth', 0.5)
addSoccerVar('GoalHeight', 0.8)
addSoccerVar('PenaltyLength',0.6)
addSoccerVar('PenaltyWidth',2.2)
addSoccerVar('FreeKickDistance', 0.75)
